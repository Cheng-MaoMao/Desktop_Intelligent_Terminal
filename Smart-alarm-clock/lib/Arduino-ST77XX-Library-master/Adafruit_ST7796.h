#ifndef _ADAFRUIT_ST7796H_
#define _ADAFRUIT_ST7796H_
...
public:
  Adafruit_ST7796(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk,
                  int8_t rst = -1);

  Adafruit_ST7796(int8_t cs, int8_t dc, int8_t rst);
#if !defined(ESP8266)
  Adafruit_ST7796(SPIClass *spiClass, int8_t cs, int8_t dc, int8_t rst);
#endif // end !ESP8266
