...
*/
Adafruit_ST7796::Adafruit_ST7796(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk,
                                 int8_t rst)
...
/*!
    ...
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7796::Adafruit_ST7796(int8_t cs, int8_t dc, int8_t rst)
...
/*!
    ...
    @param  rst       Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7796::Adafruit_ST7796(SPIClass *spiClass, int8_t cs, int8_t dc,
                                 int8_t rst)
...
*/
/**************************************************************************/
void Adafruit_ST7796::init(void) {
    commonInit(Rcmd1);
...
*/
/**************************************************************************/
void Adafruit_ST7796::setRotation(uint8_t m) {
  uint8_t madctl = 0;
